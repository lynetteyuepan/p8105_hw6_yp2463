...
- Data Processing: We shrinked the dataset size to 5000 rows before started to visulize the data. We use plotly to create plots. First of all, we made a histogram to display number of restaurants in each boro. Also, the boxplot was made to show the scores of restaurants for each type of cuisine. Then we made a single line plot to shows the number of rows for each inspection date through the whole study period. Finally, we created sentiment analysis plot using shiny app. We organized all plots into two page with flex_dashbord.
